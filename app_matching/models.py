...
class Matching(models.Model):
    user1 = models.ForeignKey(CustomUser, related_name='matches_initiated', on_delete=models.CASCADE)
    user2 = models.ForeignKey(CustomUser, related_name='matches_received', on_delete=models.CASCADE)
